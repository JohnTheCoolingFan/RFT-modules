...
data.raw["module"]["speed-module"].icon = "__RFT-modules__/graphics/icons/modules/speed-module-1.png"
data.raw["module"]["speed-module"].icon_size = 32
data.raw["module"]["speed-module-2"].icon = "__RFT-modules__/graphics/icons/modules/speed-module-2.png"
data.raw["module"]["speed-module-2"].icon_size = 32
data.raw["module"]["speed-module-3"].icon = "__RFT-modules__/graphics/icons/modules/speed-module-3.png"
data.raw["module"]["speed-module-3"].icon_size = 32
data.raw["module"]["effectivity-module"].icon = "__RFT-modules__/graphics/icons/modules/effectivity-module-1.png"
data.raw["module"]["effectivity-module"].icon_size = 32
data.raw["module"]["effectivity-module-2"].icon = "__RFT-modules__/graphics/icons/modules/effectivity-module-2.png"
data.raw["module"]["effectivity-module-2"].icon_size = 32
data.raw["module"]["effectivity-module-3"].icon = "__RFT-modules__/graphics/icons/modules/effectivity-module-3.png"
data.raw["module"]["effectivity-module-3"].icon_size = 32
data.raw["module"]["productivity-module"].icon = "__RFT-modules__/graphics/icons/modules/productivity-module-1.png"
data.raw["module"]["productivity-module"].icon_size = 32
data.raw["module"]["productivity-module-2"].icon = "__RFT-modules__/graphics/icons/modules/productivity-module-2.png"
data.raw["module"]["productivity-module-2"].icon_size = 32
data.raw["module"]["productivity-module-3"].icon = "__RFT-modules__/graphics/icons/modules/productivity-module-3.png"
...
data:extend({
    -- Speed
    {
        type = "module",
        name = "speed-module-4",
        icon = "__RFT-modules__/graphics/icons/modules/speed-module-4.png",
        icon_size = 32,
        icon_mipmaps = nil,
        flags = {},
        subgroup = "module",
    ...
    },
    {
        type = "module",
        name = "speed-module-5",
        icon = "__RFT-modules__/graphics/icons/modules/speed-module-5.png",
        icon_size = 32,
        icon_mipmaps = nil,
        flags = {},
        subgroup = "module",
    ...
    },
    {
        type = "module",
        name = "speed-module-6",
        icon = "__RFT-modules__/graphics/icons/modules/speed-module-6.png",
        icon_size = 32,
        icon_mipmaps = nil,
        flags = {},
        subgroup = "module",
    ...
    -- Effectivity
    {
        ...
        icon = "__RFT-modules__/graphics/icons/modules/effectivity-module-4.png",
        icon_size = 32,
        icon_mipmaps = nil,
        flags = {},
        subgroup = "module",
    ...
    },
    {
        ...
        icon = "__RFT-modules__/graphics/icons/modules/effectivity-module-5.png",
        icon_size = 32,
        icon_mipmaps = nil,
        flags = {},
        subgroup = "module",
    ...
    },
    {
        ...
        icon = "__RFT-modules__/graphics/icons/modules/effectivity-module-6.png",
        icon_size = 32,
        icon_mipmaps = nil,
        flags = {},
        subgroup = "module",
    ...
    -- Productivity
    {
        ...
        icon = "__RFT-modules__/graphics/icons/modules/productivity-module-4.png",
        icon_size = 32,
        icon_mipmaps = nil,
        flags = {},
        subgroup = "module",
    ...
    },
    {
        ...
        icon = "__RFT-modules__/graphics/icons/modules/productivity-module-5.png",
        icon_size = 32,
        icon_mipmaps = nil,
        flags = {},
        subgroup = "module",
    ...
    },
    {
        ...
        icon = "__RFT-modules__/graphics/icons/modules/productivity-module-6.png",
        icon_size = 32,
        icon_mipmaps = nil,
        flags = {},
        subgroup = "module",
