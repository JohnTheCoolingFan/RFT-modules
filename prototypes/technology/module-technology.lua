...
data:extend({
    ...
    -- Merged
    {
        type = "technology",
        name = "merged-modules",
        icon = "__RFT-modules__/graphics/technology/merged-modules.png",
        icon_size = 128,
    ...
    -- Speed-effectivity
    {
        ...
        icon = "__RFT-modules__/graphics/technology/speed-effectivity-module.png",
        icon_size = 128,
        effects = {
            {
                type = "unlock-recipe",
    ...
    -- Productivity-effectivity
    {
        ...
        icon = "__RFT-modules__/graphics/technology/productivity-effectivity-module.png",
        icon_size = 128,
        effects = {
            {
                type = "unlock-recipe",
    ...
    -- Speed-productivity
    {
        ...
        icon = "__RFT-modules__/graphics/technology/speed-productivity-module.png",
        icon_size = 128,
        effects = {
            {
                type = "unlock-recipe",
